...
import com.khizirev.client.MessageReceiver;
import com.khizirev.client.Network;
import com.khizriev.common.*;
import com.khizriev.common.FileOperationsMessage.FileOperation;
...
import static com.khizriev.common.FileOperationsMessage.FileOperation.COPY;
...
public class StoragePanelFxController implements Initializable {
	...
	private void copyFileFromCloud() {
		...
		FileOperationsMessage fileOperationsMessage = new FileOperationsMessage(COPY, focusedFileLine.getName());
